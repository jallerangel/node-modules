...
import { sumar } from "./controller.js";
import { multiplicar } from "./controller.js";

console.log(multiplicar(sumar(1, 2), sumar(4, 5)));

import chalk from "chalk";
const log = console.log;
log(chalk.green(multiplicar(sumar(1, 2), sumar(4, 5))));

log(chalk.cyanBright(multiplicar(sumar(1, 2), sumar(4, 5))));
